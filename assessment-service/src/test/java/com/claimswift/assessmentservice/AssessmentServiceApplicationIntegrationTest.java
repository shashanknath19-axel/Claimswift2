package com.claimswift.assessmentservice;
...
@SpringBootTest(
        ...
        properties = {
                ...
                "spring.datasource.url=jdbc:h2:mem:assessmentdb;MODE=MySQL;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE",
...
class AssessmentServiceApplicationIntegrationTest {
